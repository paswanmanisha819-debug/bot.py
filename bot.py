...
flash_model = genai.GenerativeModel("gemini-pro", system_instruction=SYSTEM_PROMPT)
pro_model = genai.GenerativeModel("gemini-pro", system_instruction=SYSTEM_PROMPT)
