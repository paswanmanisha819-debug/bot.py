...
flash_model = genai.GenerativeModel("gemini-1.5-pro", system_instruction=SYSTEM_PROMPT)
pro_model = genai.GenerativeModel("gemini-1.5-pro", system_instruction=SYSTEM_PROMPT)
